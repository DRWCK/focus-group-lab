...
# "Feature Selection (V23)" sidebar label), are deliberately left alone: they
# name a feature's origin, not the running tool.
TOOL_VERSION = "V37"
RUNLOG_SCHEMA = 1
...
RUNLOG_COLUMNS = [
    ...
    "projection", "scaler", "nerve_min_intersection",
...
st.sidebar.markdown("### ⚡ V25 Rerun Mode")
...
"""
        ...
        if st.session_state.mapper_analysis_data is not None:
            ...
            if st.session_state.mapper_results_html:
                ...
                _v21_render_note_parts = ["V25 render"]
                if color_by == "agent (pie composition)":
                    _v21_render_note_parts.append("pie composition (kepler HTML + V25 injection)")
