"""
SYN-IQ Mapper Analyzer V15 — Streamlit App
...
# =============================================================================
st.set_page_config(
    page_title="SYN-IQ Mapper Analyzer V15",
    page_icon="🗺️",
    layout="wide"
)
...
def check_password():
    ...
    <div style="background: linear-gradient(135deg, #1a1a2e 0%, #16213e 50%, #0f3460 100%);
        ...
        <h1 style="color: #e94560;">🗺️ SYN-IQ Mapper Analyzer V15</h1>
...
<div class="main-header">
    <h1>🗺️ SYN-IQ Mapper Analyzer V15</h1>
...
if uploaded_files and len(uploaded_files) > 1:
    multi_mode = st.sidebar.radio(
        "Multi-file mode:",
        ["Combined (pool into one Mapper)", "Batch (one Mapper per file)"],
        index=0,
        help="Combined = v14 default behavior (concatenates files into one dataset). "
             "Batch = run v14's pipeline separately on each file with the same settings, "
             "produce one Mapper per file, download all as a zip."
    )
        ...
        if st.button("🚀 Run Batch Analysis", type="primary"):
            ...
            for idx, f in enumerate(uploaded_files):
                ...
                try:
                    ...
                    _title = f"SYN-IQ V15 · {fname_safe} · {projection_type}"
...
<div style="text-align: center; color: #a0a0a0; padding: 1rem;">
    <strong>SYN-IQ Mapper Analyzer V15</strong><br>
