...
# =============================================================================
st.set_page_config(
    page_title="SYN-IQ Mapper Analyzer V12",
    page_icon="🗺️",
    layout="wide"
)
...
<div class="main-header">
    <h1>🗺️ SYN-IQ Mapper Analyzer V12</h1>
    ...
    if uploaded_file is not None:
        ...
        if st.button("🚀 Run Mapper Analysis", type="primary"):
            ...
            with st.spinner("Generating visualization..."):
                ...
                _temp_str  = " / ".join(_temps)  if len(_temps)  <= 4 else f"{len(_temps)} Conditions"
                _q_str     = " / ".join(_qs)     if len(_qs)     <= 3 else f"{len(_qs)} Questions"
        ...
        if st.session_state.mapper_analysis_data is not None:
            ...
            if st.session_state.mapper_results_html:
                st.download_button(
                    ...
                    file_name="syniq_mapper_v12_output.html",
                    mime="text/html"
                )
...
<div style="text-align: center; color: #a0a0a0; padding: 1rem;">
    <strong>SYN-IQ Mapper Analyzer V12</strong><br>
