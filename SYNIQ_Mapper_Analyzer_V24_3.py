"""
SYN-IQ Mapper Analyzer V24.3 — Streamlit App
...
# =============================================================================
st.set_page_config(
    page_title="SYN-IQ Mapper Analyzer V24.3",
    page_icon="🗺️",
    layout="wide"
)
...
def check_password():
    ...
    <div style="background: linear-gradient(135deg, #1a1a2e 0%, #16213e 50%, #0f3460 100%);
        ...
        <h1 style="color: #e94560;">🗺️ SYN-IQ Mapper Analyzer V24.3</h1>
...
<div class="main-header">
    <h1>🗺️ SYN-IQ Mapper Analyzer V24.3</h1>
...
SCHEMA_FAMILIES = {
    ...
    "response_text": ["response_text"],   # V24.3: gates Word TF-IDF lens
}
...
# V24.3: lag-free gate for the Word TF-IDF lens. The schema flags used by the
...
st.sidebar.markdown("---")
st.sidebar.markdown("---")
st.sidebar.markdown("### ⚡ V24 Rerun Mode")
        ...
        if st.button("🚀 Run Batch Analysis", type="primary"):
            ...
            for idx, f in enumerate(uploaded_files):
                ...
                try:
                    ...
                    _title = f"SYN-IQ V24 · {fname_safe} · {projection_type}"
        ...
        if _v22_should_run:
            ...
            with st.spinner("Generating visualization..."):
                ...
                if _v21_is_pca1:
                    ...
                    _v21_title = f"SYN-IQ V24 · PCA1 (1D) · {color_by}"
...
"""
        ...
        if st.session_state.mapper_analysis_data is not None:
            ...
            if st.session_state.mapper_results_html:
                ...
                _v21_render_note_parts = ["V24 render"]
                if color_by == "agent (pie composition)":
                    _v21_render_note_parts.append("pie composition (kepler HTML + V24 injection)")
...
<div style="text-align: center; color: #a0a0a0; padding: 1rem;">
    <strong>SYN-IQ Mapper Analyzer V24</strong><br>
