...
if label_mode != "None":
    show_member_panel = st.sidebar.checkbox(
        ...
        value=True,
        help="A static box, bottom-right, grouping the labeled cubes under their "
             "plurality agent, colored by agent. Cube numbers only; the pies "
             "show the full distribution. Exports with the figure."
    )
