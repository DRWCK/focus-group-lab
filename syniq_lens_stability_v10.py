"""
SYN-IQ Lens Stability Analyzer V10
...
st.set_page_config(
    page_title="SYN-IQ Lens Stability Analyzer V10",
    page_icon="🔬",
    layout="wide"
)
...
def check_password():
    ...
    <div style="background: linear-gradient(135deg, #0a0a1a 0%, #1a0a2e 40%, #0f2460 100%);
        ...
        <h1 style="color: #a78bfa;">🔬 SYN-IQ Lens Stability Analyzer V10</h1>
...
<div style="background: linear-gradient(135deg, #0a0a1a 0%, #1a0a2e 40%, #0f2460 100%);
    ...
    <h1 style="color: #a78bfa; margin: 0;">🔬 SYN-IQ Lens Stability Analyzer V10</h1>
...
<div style="text-align: center; color: #a0a0a0; padding: 1rem;">
    <strong>SYN-IQ Lens Stability Analyzer V10</strong><br>
