...
st.set_page_config(
    page_title="SYN-IQ · Vₜ Lens Analyzer v3",
    page_icon="🔬",
    layout="wide"
)
...
st.markdown("""
<div class="hero">
    <h1>🔬 SYN-IQ · Vₜ Lens Analyzer v3</h1>
...
st.markdown(
    ...
    "SYN-IQ · Vₜ Lens Analyzer v3 · Kouns, W. C. (2026) · SYNINT.AI · Tennessee 🎹 · "
