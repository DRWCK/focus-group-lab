"""
SYN-IQ Research · Cross-Question Harvester v10
...
# ── Main App ──────────────────────────────────────────────────────────────────
def main():
    st.set_page_config(page_title="SYN-IQ Cross-Question Harvester v10", layout="wide")

    if not check_password():
        return

    st.title("🎹 SYN-IQ · Cross-Question Harvester v10")
