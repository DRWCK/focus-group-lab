"""
SYN-IQ Mapper Analyzer V40 — Streamlit App
...
_v40_tab1, _v40_tab2, _v40_tab3 = st.tabs(
    ["1 · Capture panel", "2 · Panels in set", "3 · Render figure"])
    ...
    if not _v40_have:
        ...
        for _k in list(_v40_have.keys()):
            ...
            _c2.caption(
                ...
                f"drift {_v40_have[_k].get('max_drift_px', '?')} px")
