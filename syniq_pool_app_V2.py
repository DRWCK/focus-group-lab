#!/usr/bin/env python3
"""
syniq_pool_app.py  (V2)  --  Streamlit app to pool SYN-IQ mapper CSVs into combined-n datasets.
...
V2: output format choice -- export either ONE combined CSV (harvester format, all
conditions with a temperature column) or FOUR CSVs split by temperature. All validity
guards, renumbering, and n-reporting are unchanged from V1.
"""
...
st.title("SYN-IQ Mapper Pooler  (V2)")
