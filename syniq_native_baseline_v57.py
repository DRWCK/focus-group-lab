"""
SYN-IQ Native Baseline Harvester V57
...
# PAGE CONFIG
# =============================================================================
st.set_page_config(page_title="SYN-IQ V57 — IEP + V_t + CAM + Results Explorer", page_icon="🔬", layout="wide")
...
def check_password():
    ...
    <div class="main-header">
        <h1>🧬 SYN-IQ V57 — IEP + V_t + CAM + Custom Pre-Prompts + Results Explorer</h1>
        <p>1,897-Term Dictionary + Tri-Track Scoring + V_t Voice-State</p>
        <p class="subtitle"><span class="version-badge">V57</span></p>
    </div>
    """, unsafe_allow_html=True)
...
st.markdown(f"""
<div class="main-header">
    <h1>🔬 SYN-IQ V57 — IEP + V_t + CAM + CUSTOM PRE-PROMPTS</h1>
    <p>1,897-Term IEP Dictionary · Tri-Track Scoring (V3/V4/V5) · V_t Voice-State · System-Message Pre-Prompts</p>
    <p class="subtitle">
        <span class="version-badge">V57 — Custom Pre-Prompt Slots · Per-Response V_t · CAM Triangle · Core via syniq_core · Results Explorer</span>
    </p>
</div>
""", unsafe_allow_html=True)
...
<div style="text-align: center; color: #a0a0a0; padding: 1rem;">
    <strong>SYN-IQ V57 — IEP (1,897 terms) + V_t Voice-State + CAM Triangle + Tri-Track Scoring + Custom Pre-Prompts + Results Explorer</strong><br>
