...
# Footer
st.markdown("---")
st.markdown('<div style="text-align: center; color: #666; padding: 1rem;"><strong>Focus Group Lab V31</strong><br>Multi-Agent AI Research Platform<br>🎭 Assigned | 🔬 Raw Voice | 🔄 Swapped | ✏️ Custom<br>📍 Single Round | 🔄 Multi-Round | 🎭 Live Discussion<br><em>SYNINT Team — February 2026</em></div>', unsafe_allow_html=True)
