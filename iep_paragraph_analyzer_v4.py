"""
iep_paragraph_analyzer_v4.py — IEP Paragraph-Level Analysis (v4.0)
====================================================================
...
CHANGELOG
---------
v4.0 (May 10, 2026 — version rollup; consolidates v0.2.x and v0.3.x)
  Filename and version unified to v4.0. Folds the v0.3.0 (three new
  detector families: reflective-advisory, contemplative-aphoristic,
  directive) and v0.3.1 (performance/UX repair) work into a single
  shipping version, aligned with phrase analyzer v3.0. No behavior
  change from v0.3.1; this is a labeling/naming sync.
...
Run:  streamlit run iep_paragraph_analyzer_v4.py
...
def view_paste_text(color_words: bool = True):
    ...
    st.subheader("Paste Text — paragraph-level mode detection (v4.0)")
    st.caption(
...
def view_rule_inventory():
    st.subheader("Rule Inventory — v4.0")
...
def view_about():
    st.subheader("About — v4.0")
    st.markdown("""
**IEP Paragraph Analyzer v4.0** — third measurement layer in the SYN-IQ
language-only stack.
...
def main():
    ...
    st.title("📑 IEP Paragraph Analyzer  ·  v4.0")
    ...
    with st.sidebar:
        ...
        st.markdown("---")
        st.caption("v4.0: 8 detector families, 6 modes, 4 verdicts. "
