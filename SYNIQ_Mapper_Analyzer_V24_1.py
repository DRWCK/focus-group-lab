"""
SYN-IQ Mapper Analyzer V24.1 — Streamlit App
...
# =============================================================================
st.set_page_config(
    page_title="SYN-IQ Mapper Analyzer V24.1",
    page_icon="🗺️",
    layout="wide"
)
...
def check_password():
    ...
    <div style="background: linear-gradient(135deg, #1a1a2e 0%, #16213e 50%, #0f3460 100%);
        ...
        <h1 style="color: #e94560;">🗺️ SYN-IQ Mapper Analyzer V24.1</h1>
...
<div class="main-header">
    <h1>🗺️ SYN-IQ Mapper Analyzer V24.1</h1>
