...
SYN-IQ Mapper Analyzer V29 — Streamlit App
Topological Data Analysis for AI Response Profiles

V29 (new in this version)
...
# =============================================================================
st.set_page_config(
    page_title="SYN-IQ Mapper Analyzer V29",
    page_icon="🗺️",
    layout="wide"
)
...
def check_password():
    ...
    <div style="background: linear-gradient(135deg, #1a1a2e 0%, #16213e 50%, #0f3460 100%);
        ...
        <h1 style="color: #e94560;">🗺️ SYN-IQ Mapper Analyzer V29</h1>
...
<div class="main-header">
    <h1>🗺️ SYN-IQ Mapper Analyzer V29</h1>
        ...
        if st.button("🚀 Run Batch Analysis", type="primary"):
            ...
            for idx, f in enumerate(uploaded_files):
                ...
                try:
                    ...
                    _title = f"SYN-IQ V25 · {fname_safe} · {projection_type}"
        ...
        if _v22_should_run:
            ...
            with st.spinner("Generating visualization..."):
                ...
                if _v21_is_pca1 or _v27_is_tfidf1d:
                    ...
                    _v21_title = f"SYN-IQ V29 · {projection_type} · {color_by}"
                    try:
...
<div style="text-align: center; color: #a0a0a0; padding: 1rem;">
    <strong>SYN-IQ Mapper Analyzer V29</strong><br>
