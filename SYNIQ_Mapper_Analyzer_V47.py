"""
SYN-IQ Mapper Analyzer V47 — Streamlit App
...
(function() {
  ...
  function render(paths) {
    ...
    (function addDumpButton(){
      ...
      fit.onclick = function(){ if (window.v47Fit) window.v47Fit(true); };
      document.body.appendChild(fit);
    })();

    window.v47Fit = function(animate){
      try {
        if (typeof g === 'undefined' || typeof svg === 'undefined'
            || typeof zoom === 'undefined') return false;
