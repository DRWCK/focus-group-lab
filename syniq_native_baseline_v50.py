"""
SYN-IQ Native Baseline Harvester V50
...
1. ✅ Live transcript now shows question_id per entry
2. ✅ Mapper-ready tooltip format: Agent | Temperature | Question ID
   e.g. "Gemini | NATIVE | LIARS_PARADOX" — visible on every node click
3. ✅ All V48 features preserved (DOCX, CSV, JSON, VADER, FK, TTR, embeddings,
      subclass taxonomies, gradient temperatures)
...
# PAGE CONFIG
# =============================================================================
st.set_page_config(page_title="SYN-IQ V50 — Data-Driven IEP", page_icon="🔬", layout="wide")
