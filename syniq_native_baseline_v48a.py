"""
SYN-IQ Native Baseline Harvester V48a
...
# PAGE CONFIG
# =============================================================================
st.set_page_config(page_title="SYN-IQ V48a — Data-Driven IEP", page_icon="🔬", layout="wide")
...
st.markdown(f"""
<div class="main-header">
    <h1>🔬 SYN-IQ V48a — DATA-DRIVEN IEP</h1>
    <p>1,897-Term Dictionary + VADER + Flesch-Kincaid + TTR + Live Monitoring</p>
    <p class="subtitle">
        <span class="version-badge">V48a — 1897-TERM DATA-DRIVEN + VALIDATED INSTRUMENTS</span>
    </p>
</div>
""", unsafe_allow_html=True)
...
def generate_docx(df, run_id):
    ...
    # Title
    title = doc.add_heading('SYN-IQ Focus Group Results — V48a', level=0)
...
<div style="text-align: center; color: #a0a0a0; padding: 1rem;">
    <strong>SYN-IQ V48a — 1,897-Term Data-Driven Dictionary + Scientific Validation + DOCX Export</strong><br>
