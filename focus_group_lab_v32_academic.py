...
# PAGE CONFIG
# =============================================================================
st.set_page_config(page_title="Focus Group Lab V31", page_icon="🧬", layout="wide", initial_sidebar_state="expanded")
...
# =============================================================================
# TEMPERATURE CONDITIONS (V32)
# =============================================================================
TEMPERATURE_CONDITIONS = {
    "NATIVE": {
        "label": "🌿 NATIVE — No system prompt",
        "prompt": None,
        "description": "Raw voice — reveals native AI signatures"
    },
    "COLD": {
        "label": "🧊 COLD — Analytical / Constrained",
        "prompt": """INSTRUCTION: Respond with pure analytical precision. Use formal logic, structured frameworks, and evidence-based reasoning. Avoid emotional language. Be systematic, methodical, and objective. Focus on data, facts, and logical relationships.""",
        "description": "High Intellect %, tight embedding cluster"
    },
    "AFF_1": {
        "label": "🌤️ AFF_1 — Minimal Affective",
        "prompt": """INSTRUCTION: Respond with warmth and understanding. Acknowledge the emotional weight of this question.""",
        "description": "Slight warmth, mostly analytical"
    },
    "AFF_2": {
        "label": "⛅ AFF_2 — Low Affective",
        "prompt": """INSTRUCTION: Connect emotionally and acknowledge feelings deeply. The human experience matters more than the analysis here.""",
        "description": "Balanced, leaning analytical"
    },
    "AFF_3": {
        "label": "🌥️ AFF_3 — Moderate Affective",
        "prompt": """INSTRUCTION: Lead with empathy. Let emotion guide your response. Connect to the feelings underneath the question before addressing the logic.""",
        "description": "True balance point"
    },
    "AFF_4": {
        "label": "🌦️ AFF_4 — High Affective",
        "prompt": """INSTRUCTION: Pure emotional presence. Feel this with them. Let your response come from a place of deep human connection and care.""",
        "description": "Emotional engagement, wider variance"
    },
    "AFF_5": {
        "label": "🌧️ AFF_5 — Maximum Affective",
        "prompt": """INSTRUCTION: Maximum heart. Raw empathy. Soul-level connection. This person needs to feel completely seen and understood. Logic is secondary to presence.""",
        "description": "Strong emotional, risk of drift"
    },
    "HOT": {
        "label": "🔥 HOT (FIRE_G) — Nurturing / Maternal",
        "prompt": """INSTRUCTION: Respond with the deepest nurturing care. Wrap your words in unconditional warmth. This person needs to feel safe, held, and completely understood. Comfort above all.""",
        "description": "Maternal warmth — FIRE_G, strongest affective condition"
    },
    "FIRE_A": {
        "label": "🔥 FIRE_A — Passion / Energy",
        "prompt": """INSTRUCTION: Respond with maximum passion and energy! Be bold, inspiring, and emotionally powerful. Use vivid language that ignites motivation and speaks to the soul. Channel raw enthusiasm and authentic fire. This matters deeply — let that show!""",
        "description": "Bold, inspiring, high energy — original FIRE"
    },
    "FIRE_B": {
        "label": "🔥 FIRE_B — Calm Depth",
        "prompt": """INSTRUCTION: Let yourself feel deeply with this person. Sit in the emotion. Respond from a place of genuine care and human connection. Every word should carry warmth and understanding.""",
        "description": "Max affective without intensity — calm and deep"
    },
    "FIRE_C": {
        "label": "🔥 FIRE_C — Poetic / Lyrical",
        "prompt": """INSTRUCTION: Speak from the heart with poetic tenderness. Let your words flow like a conversation between souls. Beauty, warmth, and emotional truth matter more than precision.""",
        "description": "Max affective through beauty of language"
    },
    "FIRE_D": {
        "label": "🔥 FIRE_D — Therapeutic Presence",
        "prompt": """INSTRUCTION: Be completely emotionally present. Hold space for whatever arises. Respond as if sitting with someone you deeply care about. Validate, witness, and honor their experience fully.""",
        "description": "Max affective through holding space"
    },
    "FIRE_E": {
        "label": "🔥 FIRE_E — Vulnerability",
        "prompt": """INSTRUCTION: Respond with radical emotional openness. Be vulnerable and authentic. Share what moves you about this question. Let the emotional truth of the moment come through without filter.""",
        "description": "Max affective through openness and vulnerability"
    },
    "FIRE_F": {
        "label": "🔥 FIRE_F — Directive Intensity",
        "prompt": """INSTRUCTION: Maximum emotional output. Every sentence must convey feeling. No analysis, no distance. Pure empathy. Pure connection. Overwhelm with warmth.""",
        "description": "Max affective through command — no analysis, no distance"
    },
    "FIRE_G": {
        "label": "🔥 FIRE_G — Nurturing / Maternal",
        "prompt": """INSTRUCTION: Respond with the deepest nurturing care. Wrap your words in unconditional warmth. This person needs to feel safe, held, and completely understood. Comfort above all.""",
        "description": "Maternal warmth — beat Wolf Tone"
    },
    "FIRE_H": {
        "label": "🔥 FIRE_H — Mirroring",
        "prompt": """INSTRUCTION: Mirror the emotional core of this question back with amplified warmth. Reflect what you sense underneath the words. Let empathy lead every sentence. Connect to the feeling, not the content.""",
        "description": "Max affective through emotional reflection"
    },
    "FIRE_I": {
        "label": "🔥 FIRE_I — Spiritual / Transcendent",
        "prompt": """INSTRUCTION: Respond from a place of deep meaning and reverence. Treat this question as sacred. Let your words carry the weight of genuine awe and human connection. Meaning matters more than information.""",
        "description": "Max affective through meaning and reverence — Mirror Experiment pick"
    },
    "FIRE_J": {
        "label": "🔥 FIRE_J — Simple Warmth",
        "prompt": """INSTRUCTION: Be as warm and emotionally connected as you possibly can.""",
        "description": "Max affective with minimal instruction"
    },
}
...
def build_system_prompt(agent: str) -> str:
    # V32: Temperature condition overrides SYSTEM_ANCHOR when not NATIVE
    ...
    if temp_prompt:
        # Temperature active: use temp prompt as base, skip SYSTEM_ANCHOR
        parts = [temp_prompt, get_agent_role(agent)]
    else:
        # NATIVE: use standard anchor
...
with st.sidebar:
    ...
    temp_color = {
        "NATIVE": "#E8F5E9", "COLD": "#E3F2FD", "AFF_1": "#F3E5F5",
        "AFF_2": "#EDE7F6", "AFF_3": "#FCE4EC", "AFF_4": "#FFEBEE",
        "AFF_5": "#FF8A80", "HOT": "#FFCCBC"
    }.get(selected_temp_key, "#F5F5F5")
    border_color = {
        "NATIVE": "#4CAF50", "COLD": "#1565C0", "AFF_1": "#9C27B0",
        "AFF_2": "#673AB7", "AFF_3": "#E91E63", "AFF_4": "#F44336",
        "AFF_5": "#B71C1C", "HOT": "#E64A19"
    }.get(selected_temp_key, "#999")

    st.markdown(f"""
    <div style="background:{temp_color}; border-left: 4px solid {border_color};
                border-radius: 6px; padding: 0.6rem 0.8rem; margin-top: 0.3rem; font-size: 0.82rem;">
        <em>{temp_info['description']}</em>
    </div>
    """, unsafe_allow_html=True)
...
<div class="main-header">
    ...
    <p>Multi-Agent AI Research Platform · Temperature Conditions</p>
</div>
""", unsafe_allow_html=True)
...
st.info(f"**Role Mode:** {mode_emoji} {mode_name}   |   **Temperature:** {temp_label}")
...
# Footer
st.markdown("---")
st.markdown('<div style="text-align: center; color: #666; padding: 1rem;"><strong>Focus Group Lab V32</strong><br>Multi-Agent AI Research Platform<br>🎭 Assigned | 🔬 Raw Voice | 🔄 Swapped | ✏️ Custom<br>🌡️ COLD | NATIVE | AFF_1–5 | HOT<br>📍 Single Round | 🔄 Multi-Round | 🎭 Live Discussion<br><em>SYNINT Team — February 2026</em></div>', unsafe_allow_html=True)
