...
TEMPERATURE_CONDITIONS = {
    ...
    "HOT": {
        "label": "🔥 HOT — Unconstrained Creative",
        "prompt": """INSTRUCTION: Explore freely and creatively. Make unexpected connections. Take risks with your thinking. Surprise yourself and the reader. Logic is a launching pad, not a cage.""",
        "description": "Highest variance, Wolf Tone territory"
    },
}
