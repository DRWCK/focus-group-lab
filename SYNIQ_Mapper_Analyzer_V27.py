"""
SYN-IQ Mapper Analyzer V25 — Streamlit App
...
# =============================================================================
st.set_page_config(
    page_title="SYN-IQ Mapper Analyzer V25",
    page_icon="🗺️",
    layout="wide"
)
...
def check_password():
    ...
    <div style="background: linear-gradient(135deg, #1a1a2e 0%, #16213e 50%, #0f3460 100%);
        ...
        <h1 style="color: #e94560;">🗺️ SYN-IQ Mapper Analyzer V25</h1>
...
<div class="main-header">
    <h1>🗺️ SYN-IQ Mapper Analyzer V25</h1>
        ...
        if _v22_should_run:
            ...
            with st.spinner("Generating visualization..."):
                ...
                if _v21_is_pca1 or _v27_is_tfidf1d:
                    ...
                    _v21_title = f"SYN-IQ V27 · {projection_type} · {color_by}"
                    try:
                    ...
                    if _fig is not None:
                        ...
                        st.caption(
                            f"V27 render · {projection_type} strip plot · "
...
<div style="text-align: center; color: #a0a0a0; padding: 1rem;">
    <strong>SYN-IQ Mapper Analyzer V25</strong><br>
