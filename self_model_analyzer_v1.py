...
if not st.session_state.authenticated:
    st.markdown("""
    <div style="max-width:400px;margin:8rem auto;background:#0f0f1a;
         border:1px solid #252540;border-radius:12px;padding:2.5rem;text-align:center;">
        <div style="font-family:JetBrains Mono,monospace;color:#a78bfa;
                    font-size:1.4rem;margin-bottom:0.5rem;">🧬 SYN-IQ</div>
        <div style="color:#6b6b90;font-size:0.85rem;margin-bottom:1.5rem;">
            Self-Model Analyzer v1.0</div>
    </div>
