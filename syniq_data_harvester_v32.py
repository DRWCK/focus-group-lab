...
WHAT'S NEW IN V32:
1. Everything from V31 (dual dictionaries, prompt logging, delta calculation)
2. CONTAMINATION SIGNATURE — Top 5 words driving Custom-NRC delta
3. POTENTIAL INFLATORS — Identifies words in Custom Affective that aren't in NRC
4. RUN COUNTER — Tracks run number within session for batch analysis
5. Enhanced CSV export with all new fields
