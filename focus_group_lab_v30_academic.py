...
- Stance Control (Support / Neutral / Challenge)
...
"""
    ...
    md += "\n---\n\n*Focus Group Lab V30 — Multi-Agent AI Research Platform*\n*SYNINT Team — January 2026*\n"
    return md
...
# Footer
st.markdown("---")
st.markdown('<div style="text-align: center; color: #666; padding: 1rem;"><strong>Focus Group Lab V30</strong><br>Multi-Agent AI Research Platform<br>🎭 Assigned | 🔬 Raw Voice | 🔄 Swapped | ✏️ Custom<br><em>SYNINT Team — January 2026</em></div>', unsafe_allow_html=True)
