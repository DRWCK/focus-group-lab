"""
SYN-IQ Mapper Analyzer V16 — Streamlit App
...
# =============================================================================
st.set_page_config(
    page_title="SYN-IQ Mapper Analyzer V16",
    page_icon="🗺️",
    layout="wide"
)
...
def check_password():
    ...
    <div style="background: linear-gradient(135deg, #1a1a2e 0%, #16213e 50%, #0f3460 100%);
        ...
        <h1 style="color: #e94560;">🗺️ SYN-IQ Mapper Analyzer V16</h1>
...
<div class="main-header">
    <h1>🗺️ SYN-IQ Mapper Analyzer V16</h1>
        ...
        if st.button("🚀 Run Batch Analysis", type="primary"):
            ...
            for idx, f in enumerate(uploaded_files):
                ...
                try:
                    ...
                    _title = f"SYN-IQ V16 · {fname_safe} · {projection_type}"
                    ...
                    for e in _subset['embedding']:
                        try:
                            ...
                            try:
                                ...
                                _emb.append(None)
                    _good = [i for i,e in enumerate(_emb) if e is not None]
                    if _good:
...
<div style="text-align: center; color: #a0a0a0; padding: 1rem;">
    <strong>SYN-IQ Mapper Analyzer V16</strong><br>
