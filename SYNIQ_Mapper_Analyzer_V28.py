"""
SYN-IQ Mapper Analyzer V28 — Streamlit App
Topological Data Analysis for AI Response Profiles

V28 (new in this version)
...
# =============================================================================
st.set_page_config(
    page_title="SYN-IQ Mapper Analyzer V28",
    page_icon="🗺️",
    layout="wide"
)
...
def check_password():
    ...
    <div style="background: linear-gradient(135deg, #1a1a2e 0%, #16213e 50%, #0f3460 100%);
        ...
        <h1 style="color: #e94560;">🗺️ SYN-IQ Mapper Analyzer V28</h1>
...
<div class="main-header">
    <h1>🗺️ SYN-IQ Mapper Analyzer V28</h1>
...
def _v28_answer_membership(graph, df, valid_indices, id_col="turn_id"):
    ...
    ans_nodes = _dd(list)       # member idx -> [node_id]
    ...
    for node_id, members in graph.get("nodes", {}).items():
        ...
        for m in mem:
            ans_nodes[m].append(str(node_id))
    ...
    node_table = pd.DataFrame(node_rows).sort_values(
        ["size", "node"], ascending=[False, True]
    ...
    lead = [c for c in ("answer", "run", "agent", "question_id", "temperature",
                        "depth", "status", "n_nodes", "nodes", "smallest_node",
        ...
        if _v22_should_run:
            ...
            with st.spinner("Generating visualization..."):
                ...
                if _v21_is_pca1 or _v27_is_tfidf1d:
                    ...
                    _v21_title = f"SYN-IQ V28 · {projection_type} · {color_by}"
                    try:
                    ...
                    if _fig is not None:
                        ...
                        st.caption(
                            f"V28 render · {projection_type} strip plot · "
            ...
            if _v28_graph is not None and _v28_df is not None and _v28_valid:
                ...
                try:
                    ...
                    with _t1:
                        ...
                        st.download_button(
                            "📥 Node membership (CSV)",
                            _v28_nodes.to_csv(index=False),
                            "v28_node_membership.csv", "text/csv",
                            key="v28_dl_nodes",
                        )
                    ...
                    with _t2:
                        ...
                        st.download_button(
                            ...
                            _v28_answers.to_csv(index=False),
                            "v28_answer_membership.csv", "text/csv",
                            key="v28_dl_answers",
                        )
...
<div style="text-align: center; color: #a0a0a0; padding: 1rem;">
    <strong>SYN-IQ Mapper Analyzer V28</strong><br>
