"""
SYN-IQ Phrase Library Builder V2
==================================
...
# =============================================================================
st.set_page_config(
    page_title="SYN-IQ Phrase Library Builder V2",
    page_icon="📚",
    layout="wide"
)
...
st.markdown('<div class="main-title">📚 SYN-IQ Phrase Library Builder V2</div>', unsafe_allow_html=True)
...
with tabs[0]:
    ...
    uploaded = st.file_uploader("Upload V50 CSV or V48 DOCX", type=['csv','docx'])

    if uploaded:
        if uploaded.name.endswith('.docx'):
            if not DOCX_AVAILABLE:
                st.error("python-docx not installed on this deployment.")
                st.stop()
...
<div style="text-align:center;color:#334466;font-family:'JetBrains Mono',monospace;font-size:0.75rem;padding:1rem;">
    SYN-IQ Phrase Library Builder V2 · Tennessee 🎹 CUZ Partnership · SYNINT March 2026<br>
