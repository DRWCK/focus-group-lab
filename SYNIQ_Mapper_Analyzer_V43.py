"""
SYN-IQ Mapper Analyzer V43 — Streamlit App
    ...
    if _v41_df is None:
        ...
        if not _v41_qcol:
            ...
            st.dataframe(pd.DataFrame([
                ...
                {"setting": "Features", "value": f"{len(_v41_keys)} selected"},
            ...
            if st.button("Build all panels", key="v41_build", type="primary"):
                ...
                for _i, _q in enumerate(_v41_pick):
                    try:
                        ...
                        _panel["feature_set"] = ",".join(_v41_keys)
                ...
                if _made:
                    ...
                    st.dataframe(pd.DataFrame(
                        _made, columns=["question", "nodes", "edges", "responses"]),
